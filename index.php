...
<head>
	...
	<link rel="icon" type="image/x-icon" href="assets/images/icono3.jpg">
		...
		<div class="container mt-5 pt-5">
			<div class="row align-items-center">
				<div class="col-lg-12 text-center">
					<div class="section_title">
						<img class="img-fluid" src="assets/images/juguete-login.gif" alt="perros_y_gatos">
					</div>
				</div>
			</div>
			...
			<div class="row align-items-center ">
				<div class="col-lg-12 text-center mt-5">
					<div class="section_title">
						<h2>Los Juguetes Son Escensiales para la diversion de los niños </h2>
					</div>
				</div>
			</div>
			<?php
				...
				while ($dataProduct = mysqli_fetch_array($resultadoProductos)) { ?>
					<div class="col-6 col-md-3 mt-5 text-center Products">
						<div class="card" style="max-height: 400px !important; min-height: 400px !important;">
							...
							<h5 class="card-title card_title">// <?php // echo $dataProduct['categoria']; ?></h5>
							</div> -->
							<div>
